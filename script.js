const circleData = {
  ...
  const senseiData = {
    instructions: {
      ...
      location: `Ada sesuatu didunia kecil ini kamu harus keliling,Raina pacarku<3`,
  ...
  const mapData = {
    0: [
      ...
      { element: 'tree', angle: 70, offset: 20, color: 'navy' },
      {
        ...
        color: 'gold',
        display: {
          caption: 'Selamat datang didunia kecil buatan aku semoga enjoy ya sama buatan aku'
        }
      },
      { 
        element: 'house2', angle: 110, offset: 30,
        display: {
          caption: `Hi, ayangg ada sesuatu disini di klik yaa?`,
      ...
      { 
        ...
        display: {
          ...
          caption: 'sayangku Raina, semoga kita selalu tetep bersama!',
        }, 
      },
    ...
    1: [
      ...
      { 
        ...
        display: {
          caption: `hey there, disini ada hal menggemaskan`,
          link: linkButton(https://bart186.github.io/Kfkssvc/', `liat ayang`),
        } 
      },
      ...
      },
      {
        ...
        display: {
          ...
          caption: 'ada hadiah disini untuk mu sayang ',
          link: linkButton('https://bart186.github.io/Buatkamuu/', 'wow mauu')
        }
      },
      { 
        element: 'talking_tree', angle: 120, offset: 100, 
        display: { caption: 'jangan pernah tinggalin aku ya sayang aku cuma punya kamu' }
      },
    ...
    2: [
      ...
      { 
        ...
        display: { caption: `jangan berenti buat sayang sama aku yaa.` }
      },
    ...
    3: [
      ...
      { 
        ...
        display: { caption: `pesan dariku tetep semangat buat kehidupan kamu tetep jaga kesehatan dan tetap jadi wanita yg ceria ya aayang` },
      },
    ...
    4: [
      ...
      { element: 'cactus', angle: 50, offset: 60, color: 'navy' },
      {
        ...
        display: {
         ...
         caption: `Dibaca ya sayanggg`,
          link: linkButton('https://gifft.me/id/o/b/jw7w2dkr6bxsb1ihuyo286ou', `iyahh ayang`)
        },
      },
      {
        ...
        display: {
          ...
          caption: `Aku punya hewan peliharaan,mau liat ga?`,
          link: linkButton('https://bart186.github.io/Fffffd/', `gmw ttp harus liat`),
          button: 'meh'
        },
      },
      { 
        element: 'talking_cactus', angle: 100, offset: 20, color: 'gold', 
        display: { caption: 'jangan boong boong sama aku yaa sayang!' }
      },
    ...
    5: [
      ...
      { 
        ...
        display: {
          caption: `terima kasih telah hadir dan selalu mau berbagi waktu sama aku<3`,
        },
      },
      ...
      { 
        ...
        display: {
          ...
          caption: 'PESAN BUAT AKU DAN REAKSI KAMU?',
          link: linkButton('https://wa.me/+6285609969267', `klik`)
        }, 
      },
      ...
      { 
        ...
        display: { caption: `Aku adalah bulan tapi tidak seindah matamu , pesan dariku ily today tomorrow n forever!` },
      },
    ],
  }
